...
public class DriveSubsystem extends SubsystemBase {
  ...
  //         });
  private Pigeon2 m_pigeon = new Pigeon2(13, "rio"); // TODO pass canbus in and ID
  ...
  public DriveSubsystem(SwerveModuleConstants frontLeftModuleConstants, SwerveModuleConstants frontRightModuleConstants, SwerveModuleConstants backLeftModuleConstants, SwerveModuleConstants backRightModuleConstants) {
  ...
  public void updateOdometry() {
    ...
    for (int i = 0; i < mSwerveMods.length; i++) {
      ...
      var modulePositionFromChassis =
              kModuleTranslations[i]//module.getModuleNumber()]
  ...
  public void simulationPeriodic() {
    ...
    m_pigeon.getSimCollection().setRawHeading(-Units.radiansToDegrees(m_simYaw));
        ...
        // Log odometry pose
//TODO        Logger.getInstance().recordOutput("Odometry/Robot", m_odometry.getPoseMeters());
