...
public class TeleopSwerve extends CommandBase {
    ...
    public double percentSpeed = 0.5; // TODO increase for driver
     ...
     * Driver control
     */
    public TeleopSwerve(SwerveDrive s_Swerve, CommandXboxController controller, int translationAxis, int strafeAxis, int rotationAxis, boolean fieldRelative, boolean openLoop, double percentSpeed) {
    ...
    @Override
    public void execute() {
        Logger.getInstance().recordOutput("TeleopSwerve/percentSpeed", this.percentSpeed);
