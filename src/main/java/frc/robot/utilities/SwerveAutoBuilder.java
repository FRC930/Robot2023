 ...
 * 
 * duplicated from PathPlanner library, needed to use our version of PPSwerveControllerCommand
 */
public class SwerveAutoBuilder extends BaseAutoBuilder {
   ...
   * <h3>SwerveAutoBuilder</h3>
   * 
   * Creates an auto builder that will create command groups that will handle path following and
   * triggering events.
   *
